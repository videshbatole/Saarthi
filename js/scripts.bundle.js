...
$("#active").click(function () {
  $("#upcomming").removeClass("active-event");
  $("#active").addClass("active-event");
  $("#list-of-upcomming-events").css("display", "none");
  $("#list-of-active-events").css("display", "block");
...
$("#upcomming").click(function () {
  ...
  $("#upcomming").addClass("active-event");

    $("#list-of-upcomming-events").css("display", "block");
  $("#list-of-active-events").css("display", "none");
...
$(document).ready(function () {
  ...
  $("#event-search1").on("keyup", function () {
    console.log("ac");
    var value = $(this).val().toLowerCase();
    $("#activeTable1 tr").filter(function () {
      $(this).toggle($(this).text().toLowerCase().indexOf(value) > -1);
    });
  });

    $("#event-search2").on("keyup", function () {
      console.log("ac");
      var value = $(this).val().toLowerCase();
      $("#upcomming-table tr").filter(function () {
        $(this).toggle($(this).text().toLowerCase().indexOf(value) > -1);
      });
    });
});
