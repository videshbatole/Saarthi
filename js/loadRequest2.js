function loadRequest(id) {
  $.ajax({
    type: "POST",
    url: "php/server.php",
    data: jQuery.param({ loadRequest2: "yes", userId: id }),
              ...
              <div id="request-container" data-filter-item data-filter-name="${response[index].request_id}">
                            <div class="requests" >
                                ...
                                <div class="user-details">
                                    ...
                                    <h1 class="request-user-name">${response[index].firstName}</h1>
                                </div>
                                ...
                                <div class="request-action-btn">
                                    ...
                                    <button class="action-btn btn-accept" onclick="acceptRequest('${response[index].request_id}')"><i class="fa-duotone fa-check"></i></button>
                                ...
                                <div class="request-full-details  " id="req_${response[index].request_id}">
                                    ...
                                    <div class="reques-full-detail-section2 ">
                                        ...
                                        <div class="request-user-full-details" >
                                            <div>
                                                <h1 style="font-size: 20px !important;">Email</h1>
                                                <h5 >${response[index].beneficiary_email}</h5>
                                            </div>

                                            <div>
                                                <h1 style="font-size: 20px !important; width:350px;" >Mobile No</h1>
                                                <h5 >${response[index].beneficiary_mobile}</h5>
                                            </div>

                                            <div>
                                                <h1 style="font-size: 20px !important; width:350px;">Country</h1>
                                                <h5>${response[index].beneficiary_country}</h5>
                                            </div>

                                            <div>
                                                <h1 style="font-size: 20px !important; width:350px;">State</h1>
                                                <h5>${response[index].beneficiary_state}</h5>
                                            </div>

                                            <div>
                                                <h1 style="font-size: 20px !important; width:350px;">City</h1>
                                        ...
                                        <h5 class="user-detail-hr">User Details</h5>
                                        <div class="request-user-full-details">
                                            <div>
                                                <h1 style="font-size: 20px !important; width:350px;">Email</h1>
                                                <h5>${response[index].email}</h5>
                                            </div>
