...
// get Country function
    ...
    $("#individual").submit(function (evt) {
      evt.preventDefault();
      let passwor = passwordValidation($("#password").val(), $("#confirmPassword").val());
      if (passwor === true) {
    ...
    $("#nfirst-next").click(function () {
      ...
      let registrationNo = isEmpty($("#ngoRegistrationNo").val(), "Registration No");
      let pan = panValidation($("#panNo").val());
      let establishmentDate = dateValidate($("#establishDate").val() , " Establishment ");
      let mobileNo = mobileValidation($("#ngoMobileNo").val());
      let email = emailValidation($("#ngoEmail").val());

      if (ngoName === true && registrationNo === true && pan === true && establishmentDate === true && mobileNo === true && email === true) {
    ...
    $("#nprev-2").click(function () {
     ...
     $("#nnext-2").click(function () {
       ...
       let setlorFirstName = nameValidation($("#setlorFirstName").val(), "Setlor ");
       ...
       if (setlorFirstName === true && setlorLastName === true && setlorGender === true && setlorMobileNo === true && setlorEmail === true) {
...
//ngo address validation
       $("#nnext-3").click(function () {
         ...
         if (address === true && country === true && state === true && city === true && pincode === true) {
            step("#nstep4", "#nstep3");
         }
       });
 ...
 $("#nprev-3").click(function () {
   step("#nstep3", "#nstep4");
    ...
    $("#ngo").submit(function (evt) {
      evt.preventDefault();
      let password = passwordValidation($("#ngoPassword").val(), $("#ngoConfirmPassword").val());
      if (password === true) {
